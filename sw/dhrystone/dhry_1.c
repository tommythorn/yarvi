  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  int Instructions_Per_Cycle_x1000 = (1000 * User_Insn) / User_Time;
  printf("Instructions_Per_Cycle: %d.%d%d%d\n", Instructions_Per_Cycle_x1000 / 1000,
		(Instructions_Per_Cycle_x1000 / 100) % 10,
		(Instructions_Per_Cycle_x1000 / 10) % 10,
		(Instructions_Per_Cycle_x1000 / 1) % 10);
